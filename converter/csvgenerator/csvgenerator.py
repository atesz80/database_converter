...
class CSVGenerator(object):
    ...
    def __init__(self, filename: str, fieldnames: list, content: list, path: str = 'csv_files') -> None:
    ...
    def csv_generator(self):
        ...
        with open(os.path.join(self.path, self.filename), 'w', newline='') as csvfile:
